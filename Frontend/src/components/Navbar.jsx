...
const Navbar = () => {
  const [authUser] = useAuth(); // directly fetching authUser from context
  ...
  return (
    <div className={`w-full fixed top-0 left-0 right-0 ${sticky ? "sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out z-50" : ""}`}>
      <div className="navbar px-4">
        ...
        <div className="navbar-end space-x-3">
          ...
          {/* Conditionally show Logout if user is authenticated, otherwise show Login button */}
          {authUser ? (
            <Logout />
          ) : (
            <div className=''>
